...
func MongoDBCheck() (string, error) {
	...
	if oldVersion != "" && oldVersion == version {
		...
		addToNotUpdated(AppVersion{Name: "MongoDB", OldVersion: oldVersion, NewVersion: version})
		...
		addToUpdated(AppVersion{Name: "MongoDB", OldVersion: oldVersion, NewVersion: version})
		CreateNews("MongoDB", oldVersion, version, false)
	} else {
		log.Debug().Msg("Storing initial MongoDB version: " + version)
		addToNotUpdated(AppVersion{Name: "MongoDB", OldVersion: version})
	}
